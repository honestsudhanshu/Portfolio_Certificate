...
function Footer() {
    ...
    const handleSubmit = (e) => {
        ...
        emailjs.send('service_7xnkzsd', 'template_lpv68ce', formData, 'X6E1mdtNe10DDXjly')
            .then((response) => {
    ...
    return (
        ...
        <>
                    ...
                    <div className="c-social">
                        ...
                        <div className="c-handles">
                            ...
                            <div className="c-handle phone ">
                                <a href="tel:+917027965940" target="_blank" rel="noopener noreferrer">
            ...
            <div className="footer">
                ...
                <div className="cp">
                    <p>© 2024 Sudhanshu Kumar. All rights reserved.</p>
                </div>
            </div>
